      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            placeholder="MacBook"
            className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 focus:border-zinc-400 dark:focus:border-[#BFF355] outline-none rounded-md px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100"
          />
        </div>
        <button
          onClick={register}
        ...
        <ul className="text-xs text-zinc-500 dark:text-zinc-500 mt-4 space-y-1.5">
          <li className="flex items-center gap-2">
            <Check size={12} className="text-[#BFF355]" />
